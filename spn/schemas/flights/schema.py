...
def gen_flights_5B_schema(csv_path):
    ...
    schema.table_dictionary['flights'].sample_rate = 0.01
    schema.table_dictionary['flights'].table_size = 5000000000
...
def gen_flights_5M_schema(csv_path):
    ...
    schema.table_dictionary['flights'].sample_rate = 0.01
    schema.table_dictionary['flights'].table_size = 5000001 # sampled:49969

    return schema

def gen_flights_50M_schema(csv_path):
    schema = gen_flights_10M_schema(csv_path)

    schema.table_dictionary['flights'].sample_rate = 0.01
    schema.table_dictionary['flights'].table_size = 50000000
