...
class network(nn.Module):
    ...
    def forward(self, spn_values, spn_preds, output):
        ...
        #print("size(spn_values):", spn_values.shape)
        #print("len(spn_input_dims):", len(self.spn_input_dims))
        ...
        if self.cfg.useTree:
            ...
            #print(spn_values[0].shape)
            #print(spn_values[1].shape)
            #exit()
        ...
        #print(encoded_features.shape, preds_encoded_feature.shape, spn_preds_mean.shape)
        #print(torch.cat([encoded_features, preds_encoded_feature, spn_preds_mean], dim=1).shape)
