...
def gen_sf1_ssb_schema(csv_path):
    ...
    # sampled: 60044 not sampled: 6001173
    table_sizes = {'lineorder': 60044,
                   'dwdate': 2557,
                   'part': 200000,
                   'supplier': 2000,
                   'customer': 3000}
    schema.table_dictionary['lineorder'].sample_rate = 0.01
...
def gen_sf10_ssb_schema(csv_path):
    schema = gen_500gb_ssb_schema(csv_path)
    # not sampled: 59986217 sampled:598964
    table_sizes = {'lineorder': 598964,
                   'dwdate': 2557,
                   'part': 800000,
                   'supplier': 20000,
                   'customer': 300000}
...
def gen_sf50_ssb_schema(csv_path):
    schema = gen_500gb_ssb_schema(csv_path)
    # not sampled: 300005883 sampled: 3001252
    # model1: 300527
    table_sizes = {'lineorder': 300527,
                   'dwdate': 2557,
                   'part': 1200000,
                   'supplier': 100000,
                   'customer': 1500000}
    schema.table_dictionary['lineorder'].sample_rate = 0.001
    for table in schema.tables:
        table.table_size = table_sizes[table.table_name]
        schema.table_dictionary[table.table_name].table_size = table_sizes[table.table_name]
