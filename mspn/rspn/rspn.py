...
from .learning.rspn_learning import learn_mspn
from .structure.leaves import IdentityNumericLeaf, identity_expectation, Categorical, categorical_likelihood_range, \
...
class RSPN:
    ...
    def _probability(self, return_node_status, range_conditions):
        """
        ...
        return self._indicator_expectation(return_node_status, [], range_conditions=range_conditions)

    def _indicator_expectation(self, return_node_status, feature_scope, identity_leaf_expectation=None, inverted_features=None,
    ...
    def _indicator_expectation_with_std(self, return_node_status, feature_scope, inverted_features=None,
        ...
        :return:
        """
        e_x, node_status_x = self._indicator_expectation(return_node_status, feature_scope, identity_leaf_expectation=identity_expectation,
        ...
        e_x_sq, node_status_sq = self._indicator_expectation(return_node_status, feature_scope,
    ...
    def _unnormalized_conditional_expectation_with_std(self, return_node_status, feature_scope, inverted_features=None,
        ...
        """
        range_conditions = self._augment_not_null_conditions(feature_scope, range_conditions)
        p = self._probability(return_node_status, range_conditions)
        ...
        e_x, node_status_x = self._indicator_expectation(return_node_status, feature_scope, inverted_features=inverted_features,
                                          range_conditions=range_conditions,
                                          gen_code_stats=gen_code_stats) / p
    ...
    def _normalized_conditional_expectation(self, return_node_status, feature_scope, inverted_features=None, normalizing_scope=None,
        ...
        if normalizing_scope is None or len(normalizing_scope) == 0:
            if standard_deviations:
                return self._unnormalized_conditional_expectation_with_std(return_node_status, feature_scope,
                                                                           inverted_features=inverted_features,
                                                                           range_conditions=range_conditions,
                                                                           gen_code_stats=gen_code_stats)
            else:
        ...
        std = None
        if standard_deviations:
            std, _ = self._unnormalized_conditional_expectation_with_std(return_node_status, feature_scope,
                                                                         inverted_features=inverted_features,
                                                                         range_conditions=range_conditions,
                                                                         gen_code_stats=gen_code_stats)

        nominator, node_status_no = self._indicator_expectation(return_node_status, feature_scope,
                                                inverted_features=inverted_features,
                                                range_conditions=range_conditions,
                                                gen_code_stats=gen_code_stats)
